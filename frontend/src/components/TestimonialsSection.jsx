...
export const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "Dr. Anya's reading was incredibly accurate and insightful. She helped me understand my true calling.",
      name: "Priya S.",
      location: "Mumbai"
    },
    {
      quote: "I was struggling with career choices, and her guidance provided the clarity I needed. Highly recommend!",
      name: "Rahul K.",
      location: "Bengaluru"
    },
    {
      quote: "The compatibility analysis truly transformed my relationship. Thank you for your wisdom, Dr. Anya.",
      name: "Smita D.",
      location: "Delhi"
    },
    {
      quote: "Her predictions about my financial future were spot on. I'm grateful for the timely advice.",
      name: "Arjun R.",
      location: "Hyderabad"
    }
  ];
  ...
  return (
    <section id="testimonials" className="bg-orange-50 py-16 md:py-24">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-orange-800 mb-12 border-b-4 border-orange-400 pb-2 inline-block animate-fade-in-up">
          What Our Clients Say
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className={`bg-white p-8 rounded-xl shadow-lg border border-orange-200 text-left flex flex-col justify-between hover:shadow-xl transition-shadow duration-300 animate-fade-in-up`} style={{ animationDelay: `${index * 150}ms` }}>
              <Star className="text-amber-400 w-6 h-6 mb-4" />
